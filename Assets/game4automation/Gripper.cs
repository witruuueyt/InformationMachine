...
namespace game4automation
{
    ...
    public class Gripper : BehaviorInterface
    {
        ...
        new void Awake()
        {
            ...
            this.gameObject.layer = LayerMask.NameToLayer("g4a MU");
            if (nofingers)
            {
            ...
            RayCastSensor.AdditionalRayCastLayers.Add("g4a SensorMU");
            RayCastSensor.AdditionalRayCastLayers.Add("g4a MU");
        ...
        void UpdateGripper()
        {
            ...
            if (usefingers)
            {
                leftfinger.transform.localPosition =
                    leftstartpos + DirectionClosing * (posabs + OpenPosOffset) / Game4AutomationController.Scale;
                rightfinger.transform.localPosition =
                    rightstartpos - DirectionClosing * (posabs + OpenPosOffset) / Game4AutomationController.Scale;
            }
        }

...
namespace game4automation
{
    ...
    public class SimpleJoint : Game4AutomationBehavior
    {
       ...
       public bool UseLimits;
        ...
        public void InitJoint()
        {
            ...
            if (UseLimits)
            {
                ...
                if (Axis == DIRECTION.LinearX || Axis == DIRECTION.LinearY || Axis == DIRECTION.LinearZ)
                {
                    ...
                    var ul = UpperLimit / Game4AutomationController.Scale;
                    var ll = LowerLimit / Game4AutomationController.Scale;
        ...
        void FixedUpdate()
        {
            ...
            else
            {
                ...
                Position = diff * Game4AutomationController.Scale;
            }

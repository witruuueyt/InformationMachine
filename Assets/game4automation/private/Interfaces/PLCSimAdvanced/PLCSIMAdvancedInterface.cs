...
namespace game4automation
{
    ...
    public class PLCSIMAdvancedInterface : InterfaceThreadedBaseClass
    {
        ...
        {
#if UNITY_EDITOR
            var path = Application.dataPath + "/game4automation/private/Interfaces/PLCSimAdvanced/Ressources/PLCSimAdvancedCoupler.exe";
            if (!System.IO.File.Exists(path))
            {
                ...
                if (ok)
                    Application.OpenURL("https://game4automation.com/download/PLCSimAdvancedCoupler.exe");
                return;
            }
            ...
            var exe = Application.dataPath +
                      "/game4automation/private/Interfaces/PLCSimAdvanced/Ressources/PLCSimAdvancedCoupler.exe";
            ...
            var psi = new ProcessStartInfo(filePath)
            {
                ...
                Arguments = InstanceName + " " + SyncCycleMs + " " + SyncPointMs + " " + RemoteAdress
            };

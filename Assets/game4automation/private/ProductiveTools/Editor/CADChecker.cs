...
namespace game4automation
{
    ...
    public class CADChecker : EditorWindow
    {
        ...
        [MenuItem("game4automation/CAD Checker (Pro)",false,400)]
        static void Init()
        {
            // Get existing open window or if none, make a new one:
            CADChecker window = (CADChecker) EditorWindow.GetWindow(typeof(CADChecker));
            useupperpartnaming = EditorPrefs.GetBool( "game4automation/CADChecker/UpperPartNaming",false);
            showoccurencies= EditorPrefs.GetBool( "game4automation/CADChecker/ShowOccurencies",false);
            window.Show();
        }
        ...
        void OnGUI()
        {
            ...
            GUILayout.Label("Polys", GUILayout.Width(w[2]));
        ...
        {
            EditorPrefs.SetBool( "game4automation/CADChecker/UpperPartNaming",useupperpartnaming);
            EditorPrefs.SetBool( "game4automation/CADChecker/ShowOccurencies",showoccurencies);
        }

    ...
    public class Kinematic : Game4AutomationBehavior
    {
        ...
        new void Awake()
        {
            ...
            if (Application.IsPlaying(gameObject))
            {
                ...
                if (MoveCenterEnable)
                {
                    var deltapos = new Vector3(DeltaPosOrigin.x / Game4AutomationController.Scale / transform.lossyScale.x,
                        DeltaPosOrigin.y / Game4AutomationController.Scale / transform.lossyScale.y,
                        DeltaPosOrigin.z / Game4AutomationController.Scale  / transform.lossyScale.z);
